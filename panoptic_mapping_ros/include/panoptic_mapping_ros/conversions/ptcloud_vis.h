#ifndef PANOPTIC_MAPPING_ROS_CONVERSIONS_PTCLOUD_VIS_H_
#define PANOPTIC_MAPPING_ROS_CONVERSIONS_PTCLOUD_VIS_H_
...
#endif  // PANOPTIC_MAPPING_ROS_CONVERSIONS_PTCLOUD_VIS_H_
