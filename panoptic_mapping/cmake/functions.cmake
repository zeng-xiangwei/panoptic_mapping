...
function(PROTOBUF_GENERATE_CPP2 BASE_PATH SRCS HDRS)
  if(NOT ARGN)
    message(SEND_ERROR "Error: PROTOBUF_GENERATE_CPP2() called without any proto files")
    return()
  endif(NOT ARGN)
  ...
  # Folder where the generated headers are installed to. This should resolve to
  # "install/include"
  set(PROTO_GENERATED_HEADERS_INSTALL_DIR ${CMAKE_INSTALL_PREFIX}/include)
  file(MAKE_DIRECTORY ${PROTO_GENERATED_HEADERS_INSTALL_DIR})

  # Folder where the proto files are placed, so that they can be used in other
  # proto definitions. This should resolve to "install/share/<package>/proto"
  set(PROTO_SHARE_SUB_FOLDER "proto")
  set(PROTO_FILE_INSTALL_DIR ${CMAKE_INSTALL_PREFIX}/share/${PROTO_SHARE_SUB_FOLDER})
  file(MAKE_DIRECTORY ${PROTO_FILE_INSTALL_DIR})
  ...
  foreach(FIL ${ARGN})
    ...
    # Variable for the protobuf share folder (e.g., ../install/share/<project>/proto/project-name)
    set(PROTO_SHARE_FOLDER ${PROTO_FILE_INSTALL_DIR}/${FIL_REL_DIR})
    file(MAKE_DIRECTORY ${PROTO_SHARE_FOLDER})
    ...
    add_custom_command(
      ...
      install(
          FILES ${ABS_FIL}
          DESTINATION ${PROTO_FILE_INSTALL_DIR}/${FIL_REL_DIR}
      )
  endforeach()
  ...
  include_directories(${PROTO_GENERATED_HEADERS_INSTALL_DIR})
  install(FILES ${${HDRS}}
          DESTINATION ${PROTO_GENERATED_HEADERS_INSTALL_DIR}/${FIL_REL_DIR})
